...
from threading import Thread
import time
from pca9685_lift_up import PCA9685
...
class MqttWorker:
    ...
    def on_connect(self, client,userdata, flags,rc):
        ...
        if rc==0:    # 연결성공 -> 구독신청
            client.subscribe("parking/web/reapir/#")    # 구독신청
        else:
            print("연결실패")
    ...
    def on_message(self, client, userdata, message):
        ...
        # 세차장과 정비소 카메라 작동
        if message.topic == "parking/web/repair/cam":
            if myval == "start":
    ...
    def send_camera_frame(self):
        while self.is_streaming:
            try:
                ...
                publisher.single("parking/web/repair/cam", frame, hostname="192.168.14.45")
